...
## Migration Note
**This project was migrated to [my own forgejo instance](https://git.catq.de/me/mc-dash)**

All code was removed here on github, but is still available at my own forgejo instance,
this was done since I don't want to hand my code on github for microsofts ai training...

for users, this hardly changes anything, just take the code from a different host.
